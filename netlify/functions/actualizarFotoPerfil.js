  ...
  await axios.get(directorio.directorio + "usuarios", { headers: { "x-auth-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NTIsInJvbCI6MjAsImlhdCI6MTY5ODE3OTA4N30.B0jQsHr758WzdB7Vv50q-kMHQoNlHVQvwq5E6Wpuvf" } }).then(async function (response1) {
    if (response1.status == 200) {
      for (let usuario in response1.data) {
        try {
          await axios
            .get(directorio.directorio + "usuarios/cuentas/id=" + response1["data"][usuario]["id_usuario"], { headers: { "x-auth-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NTIsInJvbCI6MjAsImlhdCI6MTY5ODE3OTA4N30.B0jQsHr758WzdB7Vv50q-kMHQoNlHVQvwq5E6Wpuvf" } })
                ...
                await axios
                  ...
                  .then(async function (response3) {
                    if (response3.status != 404) {
                      await axios.put(directorio.directorio + "usuarios/icono", {
